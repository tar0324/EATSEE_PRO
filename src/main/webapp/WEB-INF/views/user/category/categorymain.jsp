...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=221248d77611ce72b4cec08d9bf0088c&libraries=services,clusterer,drawing"></script>
</head>
<body>
<!--지도  -->
...
<!-- 					<a href=""> 클릭 시 링크 설정
												<div class="card">
													...
													<div class="card-body">
														...
														<p class="card-body-description">안녕하세요! 4월 15일 순천만
															동행구합니다!</p>
														 카드 바디 본문
														 카드 바디 푸터
															...
															<a
																...
																<div class="Qde7Q">
																	...
																	<!-- 별점 -->
																		...
																		<div>
																		<b style="margin-left:5px;font-size:small; color:#8f8f8f;"><fmt:formatNumber value="${review.rating}" pattern="0.0"/></b>
