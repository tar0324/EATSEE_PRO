		...
		<nav class="navbar navbar-light bg-white fixed-top" >
			<div class="container-fluid">
					<div class="header_inner">
            			...
            			<%-- <img alt="먹고보자" src="${contextPath }/image/mk/blacklogo.png" width="180px" height="67px"> --%>
            			</a>
       				</div>
			...
			<div class="offcanvas offcanvas-end" tabindex="-1"
				id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel" style="font-size:15px">
				<div class="offcanvas-header"  >
					<!-- 사용자 로그인시 -->
					<c:if test="${isLogOn == true && member !=null }">
						<span class="offcanvas-title" id="offcanvasNavbarLabel" style="font-size:20px">
							  환영합니다, &nbsp;${member.user_nick }님!</span>
